      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="bg-white rounded-2xl  border border-gray-200 p-6 space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              disabled={isDisabled}
              className="w-full bg-black hover:bg-gray-800 text-white py-3 rounded-xl flex items-center justify-center gap-2 font-medium transition disabled:opacity-40"
            >
              <Send size={16} />
